...
func RegisterRoutes(group *gin.RouterGroup, service *Service) {
	...
	group.GET("/goals", h.listGoals)
	group.POST("/goals/cycles", h.createGoalCycle)
	group.POST("/goals/cycles/:id/goals", h.createGoal)
	group.POST("/goals/cycles/:id/review", h.reviewGoalCycle)
	group.POST("/goals/:id/actions", h.createGoalAction)
	group.PATCH("/goals/actions/:id", h.updateGoalAction)
	group.DELETE("/goals/actions/:id", h.deleteGoalAction)
	group.PATCH("/goals/:id", h.updateGoal)
