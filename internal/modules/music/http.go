...
func RegisterRoutes(group *gin.RouterGroup, service *Service) {
	...
	group.GET("/albums/:albumId/tags", h.listAlbumTags)
	group.POST("/albums/:albumId/tags", h.addAlbumTag)
	group.DELETE("/albums/:albumId/tags/:tagId", h.deleteAlbumTag)
	group.PUT("/albums/:albumId/tags/:tagId/vote", h.voteAlbumTag)
	group.GET("/songs/:songId/tags", h.listSongTags)
	group.POST("/songs/:songId/tags", h.addSongTag)
	group.DELETE("/songs/:songId/tags/:tagId", h.deleteSongTag)
	group.PUT("/songs/:songId/tags/:tagId/vote", h.voteSongTag)
