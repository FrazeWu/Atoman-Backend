...
func MigrateSchema(db *gorm.DB) error {
	models := []any{
		...
		&model.FeedSubscriptionRule{}, &model.FeedPreference{}, &model.SubscriptionGroup{}, &model.SubscriptionHubGroup{}, &model.SubscriptionHubMembership{}, &model.FeedItem{}, &model.FeedItemRating{},
