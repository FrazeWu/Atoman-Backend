...
func RegisterV1Routes(
	...
	forum.RegisterRoutes(group.Group("/forum"), forum.NewService(db, commentService))
	forum_engagement.RegisterRoutes(group.Group("/forum"), forum_engagement.NewService(db, commentService))
